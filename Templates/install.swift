...
func moveTemplate(templateName: String) {
    ...
    do {
        if !fileManager.fileExists(atPath: "\(destinationPath)/\(templateName)") {
            ...
            printInConsole("✅ \(templateName) Template installed succesfully 🎉. Enjoy it 🙂")
...
for template in templates {
  moveTemplate(templateName: template)
}
